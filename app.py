...
@app.route('/get_datta', methods=['GET','POST'])
def get_data_from_imagee():
    ...
    try:
        ...
        srtm = ee.Image(image_name).clip(polygon)
    ...
    #NOTE: Do more research into this line
    ...
    # NOTE: 'ee.ee_list.List', need to map for iteration
...
def get_data_from_image():
    ...
    # Static region for example purposes
...
@app.route('/median_composite', methods=['GET'])
