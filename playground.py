...
def mapping_example():
    """ Adding NDVI band to every image in an ImageCollection """
    collection = ee.ImageCollection('LANDSAT/LC08/C01/T1').filterBounds(ee.Geometry.Point(-122.262, 37.8719)).filterDate('2014-06-01', '2014-10-01');
